...
(async function() {
  ...
  const products = await Product.create([
    {name: 'iphone15', img: 'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRkfgqYo3W2oOTsTpPBlRZ6Sca8pS0sm9CmfBvlK0G8fO19TEM-', category: categories[0], price: 829.99},
    ...
    {name: 'Galaxy s22', img: 'https://image-us.samsung.com/us/smartphones/galaxy-s22/images/gallery/R0-Green/FLRC-214-R0-Green-01-PDP-GALLERY-1600x1200.jpg?$product-details-jpg$', category: categories[1], price: 619.99},
    ...
    {name: 'Pixel 7 Pro', img: 'https://lh3.googleusercontent.com/RWLzX3cvA-wb64WCwYc3wY3HvZtnD4qc8_rgHf5oDBaUxGt2DfKtxryV5K7788y_n3x9Rku4UrsfeRV2iuqtZBWfsoYMpqbiXBQ=rw-e365-nu-w525', category: categories[2], price: 899.99},
    {name: 'Pixel 7', img: 'https://lh3.googleusercontent.com/ZhOneVanVnFNt6kRonqDykl39dPoeUF2hQn0ydUtBjQtIc45XzgkFjagtfFJhxrUyn8CgXEIgfqFChDC_unMwn2O9I4OeL2JK9o=rw-e365-nu-w525', category: categories[2], price: 599.99},
    {name: 'Pixel 6a', img: 'https://lh3.googleusercontent.com/jYR2H7x-Lj1xx1rbbwRsEDaxPVO18WDho2A95kYNCDWVwZW1rIeAhqAMmWat9RafGlj6AmZNtEgd8-0jKV8B52R3fxtBAUjwKc8=rw-e365-nu-w525', category: categories[2], price: 349.99},
    {name: 'Pixel Fold', img:'https://lh3.googleusercontent.com/rubFNzpp5SPJHIm5rSLEQMB8QfU7k-XUxX5zMmVOdNG_ldO-UXmdE4UX1AacYW7gxYGyxTlmn6hnNlptIyqNS_jmq8bO34yHmA=rw-e365-w3000', category: categories[2], price: 1799.99},
    {name: 'Pixel 8 Pro', img: 'https://lh3.googleusercontent.com/HLsFbmHFSkuUvd_WQ4YBKfVNkBiTpVZLNJ0FwrdtNNqe10pkXkLrC1PYDrRLPTBquEWdHfzZ8yXBn-U8Z1sc3DcNv_1jm5tsZGof=rw-e365-w3000', category: categories[2], price: 799.99},
    {name: 'Pixel 8', img: 'https://lh3.googleusercontent.com/GCgLMaQYBwiV9cPNaHbiKJR9yk6PsuT2djEtOoKS3Xds6W-Jixul2qumlfYkOXL_vtc-Vrk1NPc3kzZUM7TDBETNlVYiGtspLpk=rw-e365-w3000', category: categories[2], price: 599.99},
    ...
    {name: 'LG G6', img: 'https://www.lg.com/levant_en/images/mobile-phones/md05804741/gallery/G6-medium02.jpg', category: categories[3], price: 154.99},
    ...
    {name: 'Huawei P50', img: 'https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/plp/phones-20230509/p-series/p50.png', category: categories[6], price: 598.99},
    {name: 'Huawei P50 Pro', img: 'https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/plp/phones-20230509/p-series/p50-pro.png', category: categories[6], price: 598.99},
    ...
    {name: 'iphone SE', img: 'https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcRsOSW_o3rdDScd1Sm9ReGNVqNMK56nG9-j7dI9J-4F5C7p7XcFutkru3bqF1EEgB1S-4ER1YZisWiAllCMKM8nJHF_B64Y', category: categories[0], price: 479.99},
  ]);
